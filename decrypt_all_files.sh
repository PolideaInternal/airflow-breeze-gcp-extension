...
#################### Directories #######################################################
export GCP_CONFIG_DIR="${GCP_CONFIG_DIR:=${MY_DIR}/workspaces/${AIRFLOW_BREEZE_WORKSPACE_NAME}/config}"
export AIRFLOW_BREEZE_KEYS_DIR="${AIRFLOW_BREEZE_KEYS_DIR:=${GCP_CONFIG_DIR}/keys}"
export AIRFLOW_BREEZE_NOTIFICATIONS_DIR="${AIRFLOW_BREEZE_NOTIFICATIONS_DIR:=${GCP_CONFIG_DIR}/notifications}"
