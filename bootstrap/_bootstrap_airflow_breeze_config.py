...
SERVICE_ACCOUNTS = [
    ...
    dict(keyfile='gcp_function.json',
         ...
         roles=['roles/source.reader', 'roles/cloudfunctions.developer', 'roles/cloudfunctions.functions.call'],
    ...
    dict(keyfile='gcp_automl.json',
         ...
         roles=['roles/automl.admin', 'roles/automl.editor', 'roles/storage.admin', 'roles/serviceusage.serviceUsageAdmin'],
    ...
    dict(keyfile='gcp_bigquery.json',
         ...
         roles=['roles/bigquery.admin', 'roles/storage.admin', 'roles/bigquery.tables.get'],
    ...
    dict(keyfile='gcp_memorystore.json',
         ...
         services=['redis.googleapis.com', 'storage-api.googleapis.com'],
         appspot_service_account_impersonation=False),
    dict(keyfile='gcp_pubsub.json',
         account_name='gcp-pubsub-account',
         account_description='Google Cloud PubSub account',
         roles=['roles/owner'],
         services=['pubsub.googleapis.com'],
         appspot_service_account_impersonation=False),
    dict(keyfile='gcp_datastore.json',
         account_name='gcp-datastore-account',
         account_description='Google Cloud Datastore account',
         roles=['roles/owner'],
         services=['datastore.googleapis.com'],
         appspot_service_account_impersonation=False),
    dict(keyfile='gcp_gke.json',          
         account_name='gcp-gke-account',
         account_description='Google Kubernetes Engine account',
         roles=['roles/container.admin', 'roles/iam.serviceAccountUser'],
         services=['container.googleapis.com'],
         appspot_service_account_impersonation=True),
    dict(keyfile='gcp_small_gcs.json',          
         account_name='gcp-small-gs-account',
         account_description='GCS small role',
